    ...
    private fun viewListener() {
        ...
        binding.tvAirLines.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                airlinesSearchAirLinesAdapter?.setList(filterList)
            }
        })
    }
    ...
    fun getDepartureFlightDataFromAirline(airLineDetail: StaticAirLineItems): ArrayList<FullDetailFlightData> {
        ...
        departureFlightList?.forEach { depFlight ->
            ...
            departureFlightData.add(
                FullDetailFlightData(
                    flightNo = depFlight.flight?.iataNumber.toString().orNA(),
                    depIataCode = depFlight.departure?.iataCode.toString().orNA(),
                    arrIataCode = depFlight.arrival?.iataCode.toString().orNA(),
                    arrAirportName = arrAirport?.nameAirport.toString().orNA(),
                    depAirportName = depAirport?.nameAirport.toString().orNA(),
                    arrCity = arrCity?.nameCity.toString().orNA(),
                    depCity = depCity?.nameCity.toString().orNA(),
                    nameAirport = "",
                    callSign = depFlight.flight?.icaoNumber.toString().orNA(),
                    scheduledArrTime = scheduleFlight?.arrival?.scheduledTime.orNA(),
                    scheduledDepTime = scheduleFlight?.departure?.scheduledTime.orNA(),
                    actualDepTime = scheduleFlight?.departure?.actualTime.orNA(),
                    actualArrTime = scheduleFlight?.arrival?.actualTime.toString().orNA(),
                    ...
                    estimatedDepTime = scheduleFlight?.departure?.estimatedTime.toString().orNA(),
                    flightIataNumber = depFlight.flight?.iataNumber.toString().orNA(),
                    airlineName = scheduleFlight?.airline?.name.toString().orNA(),
                    flightIcaoNo = depFlight.flight?.icaoNumber.toString().orNA(),
                    terminal = scheduleFlight?.arrival?.terminal.toString().orNA(),
                    gate = scheduleFlight?.departure?.gate.toString().orNA(),
                    delay = scheduleFlight?.departure?.delay?.toString().toString().orNA(),
                    scheduled = scheduleFlight?.departure?.scheduledTime.toString().orNA(),
                    altitude = depFlight.geography?.altitude?.toString().toString().orNA(),
                    direction = depFlight.geography?.direction?.toString().toString().orNA(),
                    latitude = depFlight.geography?.latitude?.toString().toString().orNA(),
                    longitude = depFlight.geography?.longitude?.toString().toString().orNA(),
                    hSpeed = depFlight.speed?.horizontal?.toString().toString().orNA(),
                    vSpeed = depFlight.speed?.vspeed?.toString().toString().orNA(),
                    status = depFlight.status.toString().orNA(),
                    squawk = depFlight.system?.squawk.toString().orNA(),
                    modelName = airPlane?.productionLine.toString().orNA(),
                    modelCode = airPlane?.modelCode.toString().orNA(),
                    airCraftType = airPlane?.enginesType.toString().orNA(),
                    regNo = airPlane?.numberRegistration.toString().orNA(),
                    iataModel = airPlane?.airplaneIataType.toString().orNA(),
