...
class FollowedFlightActivity : BaseActivity<ActivityFollowedFlightBinding>(ActivityFollowedFlightBinding::inflate),
    ...
    override fun onViewDetailedClicked(data: FollowFlightData) {
        ...
        FullDetailsFlightData = FullDetailFlightData(
            ...
            arrAirportName = trackData?.airlineName.toString(),
            depAirportName = trackData?.depCityName.toString(),
            arrCity = trackData?.arrivalCityName.toString(),
            depCity = trackData?.depCityName.toString(),
            nameAirport = trackData?.arrivalCityName.toString(),
            callSign = trackData?.callSign.toString(),
            scheduled = "5:50",
            actualDepTime = "5:50",
            gate = "3",
            scheduledDepTime = "5:50",
            scheduledArrTime = "7:15",
            estimatedArrTime = "7:20",
            ...
            planeStatus = "",
            airCraftType = "",
            airPlaneIataCode = "NA/56-7",
            airLineIataCode = trackData?.depIataCode.toString(),
            airLineICaoCode = trackData?.arrivalIataCode.toString(),
            lineNumber = "6",
            series = "9",
            productionLine = "20",
            icaoHex = "",
