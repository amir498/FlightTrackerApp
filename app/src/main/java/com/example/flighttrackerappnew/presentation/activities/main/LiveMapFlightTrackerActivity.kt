...
class LiveMapFlightTrackerActivity :
            ...
            include.consFollow.setOnClickListener {
                ...
                lifecycleScope.launch(Dispatchers.IO) {
                    FullDetailsFlightData?.let { fullDetails ->
                        ...
                        if (isFollowFlight) {
                            this@LiveMapFlightTrackerActivity.showToast("You UnFollowed this Flight")
    ...
    private fun observeLiveData() {
        viewModel.apply {
            ...
            airCraftData.observe(this@LiveMapFlightTrackerActivity) { result ->
                when (result) {
                    is Resource.Loading -> {}
    ...
    private fun initView() {
        try {
            ...
            googleMap.apply {
                ...
                listener { flightData ->
                    if (followedFlightList.any { it.flightNo == flightData.flight?.iataNumber }) {
