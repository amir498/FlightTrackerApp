...
import com.example.liveflighttrackerapp.databinding.SearchAircraftItemLayoutBinding
import com.example.liveflighttrackerapp.presentation.listener.SearchAircraftListener
...
class SearchAirCraftsAdapter : RecyclerView.Adapter<SearchAirCraftsAdapter.SearchAirportViewHolder>() {
    ...
    fun setList(list: List<FlightDataItem>) {
        flightData = list as ArrayList<FlightDataItem>
