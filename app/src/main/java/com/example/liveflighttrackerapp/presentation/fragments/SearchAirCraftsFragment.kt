...
import com.example.liveflighttrackerapp.databinding.FragmentSearchAirCraftsBinding
...
class SearchAirCraftsFragment(context: Context, attr: AttributeSet) :
    MyFragment<FragmentSearchAirCraftsBinding>(context, attr) {
    ...
    override fun setupFragment(activity: MainActivity) {
        ...
        this.binding = FragmentSearchAirCraftsBinding.bind(this)
        binding.btnBack.setOnClickListener {
            activity.onBackPress()
        }

        binding.tvFlightNumber.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                val filterList = activity.liveFlight.filter {
                    val iata = it.flight?.iataNumber.orEmpty().lowercase()
                    iata.startsWith(text.lowercase())
                }
